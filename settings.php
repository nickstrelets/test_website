<?php
//define('C_REST_CLIENT_ID','local.61eaaddb644e69.51441394');//Application ID
//define('C_REST_CLIENT_SECRET','eqAz1jzSLLzd33u7Daw8r7o0wuoUCgK1w41QDFjOB7xyFugxqj');//Application key
// or
